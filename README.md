...
=========================
 ...
 + Need to install dependencies bower i && npm i
 -------------------------
 + At the suggestion of the selection version, select the second item.
 ========================
...
--------------------------
 ...
 + Then, after the full launch galpa, go to the browser link:
 + http://localhost:8000/
========================
